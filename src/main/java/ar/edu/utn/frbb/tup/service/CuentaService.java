...
public class CuentaService {
    ...
    public void darDeAltaCuenta(Cuenta cuenta, long dniTitular) throws CuentaAlreadyExistsException, TipoCuentaAlreadyExistsException, TipoCuentaNoSupportedException {
        ...
        if (!tipoCuentaEstaSoportada(cuenta)) {
            throw new TipoCuentaNoSupportedException("El tipo de cuenta "+cuenta.getTipoCuenta()+" no está soportada.");
        }
